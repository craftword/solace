...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    {!! Form::model($hrs, ['method' => 'PUT', 'route' => ['admin.humanresource.update', $hrs->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 form-group">
                   ...
                   {!! Form::date('DATEOFBIRTH', old('DATEOFBIRTH'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-4 form-group">
                    ...
                    <div class="col-xs-4 form-group">
                        ...
                        {!! Form::date('DATEOFEMPLOYMENT', old('DATEOFEMPLOYMENT'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                        <p class="help-block"></p>
             ...
             <div class="row">
                ...
                <div class="col-xs-4 form-group">
                        ...
                        {!! Form::date('DATEOFPROMOTIONS', old('DATEOFPROMOTIONS'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                        <p class="help-block"></p>
             ...
             <div class="row">
                <div class="col-xs-4 form-group">
                       ...
                       {!! Form::date('DATEOFINTERVIEW', old('DATEOFINTERVIEW'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                        <p class="help-block"></p>
             ...
             <div class="row">
                <div class="col-xs-4 form-group">
                        {!! Form::label('DATEOFSALARYINCREASE', 'DATE OF SALARY INCREASE*', ['class' => 'control-label']) !!}
                         {!! Form::date('DATEOFSALARYINCREASE', old('DATEOFINTERVIEW'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                        <p class="help-block"></p>
