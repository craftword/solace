...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Edit Pharmacy</li>
  </ol>
</nav>
    <h3 class="page-title">Edit Drug</h3>
    {!! Form::model($drugs, ['method' => 'PUT', 'route' => ['admin.pharmacy.update', $drugs->id]]) !!}
...
<<<<<<< HEAD
                    {!! Form::select('DrugType', ['tab'=>'tab', 'bottle'=>'bottle','ampoule'=>'ampoule','vial'=>'vial','tube'=>'tube','nebule'=>'nebule','pint'=>'pint','bag'=>'bag','pack'=>'pack','roll'=>'roll', 'cap'=>'cap'], null, ['class' => 'form-control','placeholder' => 'Pick a Type...']); !!}
=======
